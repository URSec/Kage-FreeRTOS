...
/* Configuration: USE_FREERTOS_TASK
        Implementation for FreeRTOS
        This implementation uses xTaskCreate, xQueueSend/xQueueReceive, and
   vTaskDelete
*/
...
/* Configuration: USE_FREERTOS_TASK_MPU
        Implementation for FreeRTOS_MPU
        This implementation uses xTaskCreateRestricted, 
   xQueueSend/xQueueReceive, and vTaskDelete
*/
#ifndef USE_FREERTOS_TASK_MPU
#define USE_FREERTOS_TASK_MPU 0
#endif
...
static StackType_t taskStackBuffer[MULTITHREAD][STACK_SIZE * 2] TASK_STACK;
static unsigned current_task = 0;
#endif
#define PARALLEL_METHOD "FreeRTOS Task"
#else
