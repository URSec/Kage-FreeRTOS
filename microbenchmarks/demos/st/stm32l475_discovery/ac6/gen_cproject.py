...
middlewares = {
    ...
    'FreeRTOS': {
        ...
        'includes': [
            ...
            '${workspace_loc:/${ProjName}/lib/aws/FreeRTOS/portable/GCC/ARM_CM4_MPU}',
        ],
    },
    'jsmn': {
        'includes': [
...
programs = {
    'secure-api': {
        'defines': [
            'SECURE_API_MICRO_BENCHMARK',
        ],
        'includes': [
            '${workspace_loc:/${ProjName}/application_code/beebs/include}',
...
def gen_core_settings_config(conf, program):
    ...
    xml += '      </storageModule>\n'
    xml += '      <storageModule moduleId="cdtBuildSystem" version="4.0.0">\n'
    xml += '        <configuration artifactExtension="elf" artifactName="${ConfigName}" buildArtefactType="org.eclipse.cdt.build.core.buildArtefactType.exe" buildProperties="org.eclipse.cdt.build.core.buildArtefactType=org.eclipse.cdt.build.core.buildArtefactType.exe,org.eclipse.cdt.build.core.buildType=org.eclipse.cdt.build.core.buildType.release" cleanCommand="rm -rf" description="" id="fr.ac6.managedbuild.config.gnu.cross.exe.release.' + program_id + '" name="' + program_id + '" parent="fr.ac6.managedbuild.config.gnu.cross.exe.release" postannouncebuildStep="Running code scanner, Generating binary, and Printing size information:" postbuildStep="&quot;${workspace_loc}/../scripts/code-scanner.py&quot; &quot;${BuildArtifactFileBaseName}.elf&quot; &amp;&amp; arm-none-eabi-objcopy -O binary &quot;${BuildArtifactFileBaseName}.elf&quot; &quot;${BuildArtifactFileBaseName}.bin&quot; &amp;&amp; arm-none-eabi-objcopy -O ihex &quot;${BuildArtifactFileBaseName}.elf&quot; &quot;${BuildArtifactFileBaseName}.hex&quot; &amp;&amp; arm-none-eabi-size &quot;${BuildArtifactFileName}&quot;">\n'
    ...
    # Add linker script
    xml += '                <option id="fr.ac6.managedbuild.tool.gnu.cross.c.linker.script.' + program_id + '" name="Linker Script (-T)" superClass="fr.ac6.managedbuild.tool.gnu.cross.c.linker.script" useByScannerDiscovery="false" value="${ProjDirPath}/STM32L475VGTx_FLASH_MPU.ld" valueType="string"/>\n'
    ...
    # Folders of HAL
    ###########################################################################
    xml += '          <folderInfo id="fr.ac6.managedbuild.config.gnu.cross.exe.release.' + program_id + '.hal" name="/" resourcePath="lib/third_party/mcu_vendor/st/stm32l475_discovery">\n'
    xml += '            <toolChain id="fr.ac6.managedbuild.toolchain.gnu.cross.exe.release.' + program_id + '.hal" name="Ac6 STM32 MCU GCC" superClass="fr.ac6.managedbuild.toolchain.gnu.cross.exe.release.' + program_id + '" unusedChildren="">\n'
    ...
    xml += '                <option id="fr.ac6.managedbuid.gnu.c.compiler.option.misc.other.' + program_id + '.hal" superClass="fr.ac6.managedbuid.gnu.c.compiler.option.misc.other" value="--target=arm-none-eabi -mllvm -enable-arm-kage-privilege-promotion'
    if 'cflags' in configurations[conf]:
        if '-mexecute-only' in configurations[conf]['cflags']:
            xml += ' -mexecute-only'
    xml += '" valueType="string"/>\n'
    xml += '              </tool>\n'
    ...
    xml += '            <toolChain id="fr.ac6.managedbuild.toolchain.gnu.cross.exe.release.' + program_id + '.hal-2" name="Ac6 STM32 MCU GCC" superClass="fr.ac6.managedbuild.toolchain.gnu.cross.exe.release.' + program_id + '" unusedChildren="">\n'
    ...
    xml += '                <option id="fr.ac6.managedbuid.gnu.c.compiler.option.misc.other.' + program_id + '.hal-2" superClass="fr.ac6.managedbuid.gnu.c.compiler.option.misc.other" value="--target=arm-none-eabi -mllvm -enable-arm-kage-privilege-promotion'
    if 'cflags' in configurations[conf]:
        if '-mexecute-only' in configurations[conf]['cflags']:
            xml += ' -mexecute-only'
    xml += '" valueType="string"/>\n'
